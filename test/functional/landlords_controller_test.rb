...
class LandlordsControllerTest < ActionController::TestCase
  ...
  test "should create landlord" do
    assert_difference('Landlord.count') do
      post :create, landlord: { email: @landlord.email, fname: @landlord.fname, lname: @landlord.lname, password_digest: @landlord.password_digest }
    end
  ...
  test "should update landlord" do
    put :update, id: @landlord, landlord: { email: @landlord.email, fname: @landlord.fname, lname: @landlord.lname, password_digest: @landlord.password_digest }
    assert_redirected_to landlord_path(assigns(:landlord))
  end
